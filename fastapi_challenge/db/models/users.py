...
from fastapi_challenge.settings import settings


class User(SQLAlchemyBaseUserTableUUID, Base):
    """Represents a user entity.

    This class intentionally keeps only the columns/fields provided by
    `SQLAlchemyBaseUserTableUUID`. Relationship attributes (posts, comments)
    are declared here to keep model-level associations close to the table
    definition while keeping user-management logic (managers, schemas)
    separated below.
    """
